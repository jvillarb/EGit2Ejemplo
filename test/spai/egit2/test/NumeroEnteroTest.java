...
public class NumeroEnteroTest {
    ...
    @Test
    public void testIncrementarValor() {
    	assertEquals(110,this.numero.incrementarValor(10));
    }

    @Test
    public void testDecrementarValor() {
    	assertEquals(1,this.numero.decrementarValor(99));
    }
}
